...
class PybulletEnv(gym.Env):
    ...
    def __init__(self,
        ...
        Args:
          time_step: How much time is used for each simulator step.
          action_repeat: Number of interpolation between current robot joint angle and target angle.
