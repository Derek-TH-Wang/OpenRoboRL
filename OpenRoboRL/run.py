...
def main():
  ...
  if ROBOT == "xr3":
    ...
    arg_parser.add_argument("--motion_file", dest="motion_file", type=str, default="OpenRoboRL/learning/data/motions/dog_pace.txt")
    arg_parser.add_argument("--model_file", dest="model_file", type=str, default="OpenRoboRL/learning/data/policies/dog_pace.zip")
